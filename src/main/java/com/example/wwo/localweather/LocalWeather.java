package com.example.wwo.localweather;
...
/**
 * The Premium Local Weather REST API method allows you to access current
 * weather conditions and the next 15 days of accurate and reliable weather
 * forecast. The Local Weather API returns weather elements such as temperature,
 * precipitation (rainfall), weather description, weather icon and wind speed.
 * You can also use this method to get monthly climate average data for a
 * specified location, averaged over the last 12 years. Available weather
 * elements include average minimum and maximum temperatures, absolute minimum
 * and maximum temperatures, average rainfall, and average number of dry, snow,
 * and fog days. TODO: monthly avarage
 * 
 * @author Fanni_Varga
 * 
 */
public class LocalWeather {
	 ...
	 */
	public LocalWeather(PackageType packageType, String key,
	...
	/**
	 * Include extra informations. You can also specify multiple values. TODO:
	 * valudate isDayTime
	 * 
	 * @param extras
	 ...
	 */
	public LocalWeather includeExtraInformations(Extra... extras) {
		String ret = "";
	 ...
	 * @return a reference to this object.
	 */
	public LocalWeather date(Date date) {
	...
	/**
	 * Whether to return weather forecast output. Default is false.
	 * 
	 * @param fx
	 *            If needed true, else false.
	 * @return a reference to this object.
	 */
	public LocalWeather needForecastOutput(boolean fx) {
		parameters.put("fx", fx ? "yes" : "no");
		return this;
	}

	/**
	 * Whether to return current weather conditions output. Default is true.
	 * 
	 * @param cc
	 *            If needed true, else false.
	 * @return a reference to this object.
	 */
	public LocalWeather needCurrentWeatherConditions(boolean cc) {
		parameters.put("cc", cc ? "yes" : "no");
		return this;
	}
	 ...
	 * @return a reference to this object.
	 */
	public LocalWeather isIncludeLocation(boolean includeLocation) {
	 ...
	 * @return a reference to this object.
	 */
	public LocalWeather setForecastTimeInterval(Interval interval) {
	 ...
	 * @return a reference to this object.
	 */
	public LocalWeather setFormat(Format format) {
		parameters.put("format", format.getValue());
		return this;
	}

	/**
	 * Whether output contains CSV/TAB comments Default is yes.
	 * 
	 * @param show
	 *            If show comments true, else false.
	 * @return a reference to this object.
	 */
	public LocalWeather showComments(boolean show) {
		parameters.put("show_comment", show ? "yes" : "no");
		return this;
	}
	 ...
	 */
	public LocalWeather setCallback(String function) {
		parameters.put("callback", function);
		return this;
	}

	/**
	 * Whether to return the timezone information i.e. local time and offset
	 * hour and minute for the location. Default is false.
	 * 
	 * @param show
	 *            If want to show true, else false.
	 * @return a reference to this object.
	 */
	public LocalWeather showLocalTime(boolean show) {
		parameters.put("showlocaltime", show ? "yes" : "no");
		return this;
	}

	/**
	 * Returns series of GIF images for rain, snow and pressure map and surface
	 ...
	 * @return a reference to this object.
	 */
	public LocalWeather showMap(boolean show) {
		parameters.put("showmap", show ? "yes" : "no");
		return this;
	}
	 ...
	 * @return a reference to this object.
	 */
	public LocalWeather setOtherLanguage(Language language) {
	...
	public static enum PackageType {
		 ...
		 * Premium API.
		 */
		PREMIUM("/premium/v1/weather.ashx"),
		/**
		 * Free API.
		 */
		FREE("/free/v2/weather.ashx");
